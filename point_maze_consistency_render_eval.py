...
def render_eval():
    ...
    CKPT_PATH = "checkpoints/point_maze_consistency_policy.pth"
    ...
    print(f"Starting Evaluation (Action Horizon: {ACTION_HORIZON}, Steps: {CONSISTENCY_STEPS})...")
    ...
    while True: # Episode Loop
        ...
        while True: # Control Loop
            ...
            action_seq = dataset.action_normalizer.unnormalize(best_action_seq.squeeze(0).cpu().numpy())
