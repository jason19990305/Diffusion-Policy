...
if __name__ == "__main__":
    ...
    print(f"[point_maze_train] Using device: {DEVICE}")
    ...
    # ==========================================
    print("[point_maze_train] Initializing Dataset and DataLoader...")
    ...
    print(f"[point_maze_train] Dataset size: {len(dataset)} | Batches/epoch: {len(dataloader)}")
    
    # ==========================================
    # 2. Model & EMA Definition
    # ==========================================
    print("[point_maze_train] Initializing Model and EMA...")
    ...
    # Latest torch.amp API
    scaler = torch.amp.GradScaler('cuda')
    
    # ==========================================
    # 4. Training Loop
    # ==========================================
    print(f"[point_maze_train] Starting Training for {TOTAL_STEPS} steps...")
    global_step = 0
    ...
    while global_step < TOTAL_STEPS:
        for batch in dataloader:
            ...
            if global_step % SAVE_INTERVAL == 0:
                ...
                tqdm.write(f"[point_maze_train] Checkpoint saved at step {global_step} -> {checkpoint_path}")

    pbar.close()
    print(f"[point_maze_train] Training completed. Final model saved to {os.path.join(SAVE_DIR, 'point_maze_diffusion.pth')}")
